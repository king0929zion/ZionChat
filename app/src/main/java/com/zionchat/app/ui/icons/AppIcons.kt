...
object AppIcons {
    ...
    val QQ = ImageVector.Builder(
        ...
        path(
            ...
            // QQ 企鹅身体主体
            moveTo(12f, 2f)
            curveTo(7.5f, 2f, 4f, 5.5f, 4f, 9.5f)
            curveTo(4f, 11.5f, 4.8f, 13.3f, 6.1f, 14.6f)
            curveTo(6f, 14.8f, 5.9f, 15f, 5.9f, 15.2f)
            curveTo(5.7f, 16f, 5.2f, 17.8f, 4.5f, 18.8f)
            curveTo(4.2f, 19.3f, 4.5f, 20f, 5.1f, 20f)
            curveTo(6.5f, 20f, 8.2f, 19.2f, 9.2f, 18.5f)
            curveTo(10f, 18.8f, 11f, 19f, 12f, 19f)
            curveTo(16.5f, 19f, 20f, 15.5f, 20f, 11.5f)
            curveTo(20f, 7.5f, 16.5f, 2f, 12f, 2f)
            close()
            
            // 左眼
            moveTo(9f, 9.5f)
            curveTo(9f, 8.7f, 9.7f, 8f, 10.5f, 8f)
            curveTo(11.3f, 8f, 12f, 8.7f, 12f, 9.5f)
            curveTo(12f, 10.3f, 11.3f, 11f, 10.5f, 11f)
            curveTo(9.7f, 11f, 9f, 10.3f, 9f, 9.5f)
            close()
            
            // 右眼
            moveTo(13.5f, 9.5f)
            curveTo(13.5f, 8.7f, 14.2f, 8f, 15f, 8f)
            curveTo(15.8f, 8f, 16.5f, 8.7f, 16.5f, 9.5f)
            curveTo(16.5f, 10.3f, 15.8f, 11f, 15f, 11f)
            curveTo(14.2f, 11f, 13.5f, 10.3f, 13.5f, 9.5f)
            close()
            
            // 嘴巴/围巾区域
            moveTo(10f, 13f)
            curveTo(10f, 12.5f, 10.5f, 12f, 11f, 12f)
            horizontalLineTo(13f)
            curveTo(13.5f, 12f, 14f, 12.5f, 14f, 13f)
            curveTo(14f, 13.8f, 13.2f, 14.5f, 12f, 14.5f)
            curveTo(10.8f, 14.5f, 10f, 13.8f, 10f, 13f)
            close()
        }
    }.build()
}
