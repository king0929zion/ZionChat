...
object AppIcons {
    ...
    val Memory = ImageVector.Builder(
        ...
        path(
            ...
            // Notebook binding rings (3 holes on left)
            moveTo(5f, 6f)
            ...
            // Lines on notebook (representing text/memory)
            moveTo(9f, 7f)
            ...
            curveTo(18f, 10.448f, 17.552f, 10f, 17f, 10f)
            horizontalLineTo(9f)
            curveTo(8.448f, 10f, 8f, 10.448f, 8f, 11f)
            curveTo(8f, 11.552f, 8.448f, 12f, 9f, 12f)
            close()
