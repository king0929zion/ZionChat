...
object AppIcons {
    ...
    val Memory = ImageVector.Builder(
        ...
        path(
            ...
            addPathNodes(
                "M17.253,11.852C18.34,10.966 19.944,11.03 20.957,12.043C21.97,13.056 22.034,14.66 21.147,15.747L20.957,15.957L16.387,20.527C15.871,21.043 15.226,21.406 14.521,21.581L14.217,21.645L12.166,21.986C11.848,22.039 11.523,21.935 11.295,21.707C11.067,21.479 10.963,21.154 11.016,20.836L11.356,18.786L11.419,18.48C11.593,17.775 11.957,17.129 12.474,16.612L17.043,12.043L17.253,11.852ZM19.543,13.457C19.262,13.176 18.817,13.158 18.516,13.404L18.457,13.457L13.888,18.026C13.63,18.284 13.448,18.608 13.36,18.96L13.329,19.113L13.217,19.783L13.888,19.672L14.04,19.641C14.392,19.553 14.715,19.371 14.973,19.113L19.543,14.543L19.596,14.484C19.841,14.183 19.824,13.738 19.543,13.457ZM18,8.5V4.8C18,4.634 17.866,4.5 17.7,4.5H11V14C11,14.552 10.552,15 10,15C9.448,15 9,14.552 9,14V4.5H8C6.895,4.5 6,5.395 6,6.5V17.5C6,18.605 6.895,19.5 8,19.5C8.552,19.5 9,19.948 9,20.5C9,21.052 8.552,21.5 8,21.5C5.791,21.5 4,19.709 4,17.5V6.5C4,4.291 5.791,2.5 8,2.5H17.7C18.97,2.5 20,3.53 20,4.8V8.5C20,9.052 19.552,9.5 19,9.5C18.448,9.5 18,9.052 18,8.5Z"
            )
        }
    }.build()
    ...
    val Edit = ImageVector.Builder(
        ...
        path(
            ...
            addPathNodes(
                "M13.293,4.293C15.064,2.522 17.936,2.522 19.707,4.293C21.478,6.064 21.478,8.935 19.707,10.707L12.157,18.257C11.644,18.769 11.301,19.119 10.898,19.394C10.557,19.628 10.186,19.817 9.798,19.96C9.34,20.127 8.857,20.205 8.142,20.324L5.27,20.802C5.102,20.83 4.91,20.863 4.744,20.876C4.574,20.888 4.303,20.893 4.017,20.77C3.663,20.618 3.381,20.337 3.229,19.983C3.107,19.697 3.111,19.426 3.124,19.256C3.137,19.09 3.169,18.899 3.197,18.731L3.677,15.859C3.796,15.144 3.872,14.66 4.04,14.202C4.182,13.813 4.373,13.443 4.606,13.101C4.882,12.698 5.231,12.355 5.743,11.842L13.293,4.293ZM7.157,13.257C6.593,13.821 6.404,14.017 6.258,14.23C6.118,14.435 6.003,14.657 5.918,14.89C5.829,15.133 5.78,15.401 5.649,16.187L5.217,18.783L7.813,18.351C8.6,18.22 8.868,18.171 9.11,18.082C9.343,17.996 9.565,17.883 9.771,17.743C9.984,17.597 10.179,17.407 10.743,16.842L16.586,11L13,7.414L7.157,13.257ZM18.293,5.707C17.303,4.717 15.697,4.717 14.707,5.707L14.414,6L18,9.586L18.293,9.293C19.283,8.302 19.283,6.697 18.293,5.707Z"
            )
        }
    }.build()
