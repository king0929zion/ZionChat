...
object AppIcons {
    ...
    val MCPTools = ImageVector.Builder(
        ...
        path(
            ...
            verticalLineTo(6f)
            curveTo(10f, 6.55f, 10.45f, 7f, 11f, 7f)
            curveTo(11.55f, 7f, 12f, 6.55f, 12f, 6f)
            verticalLineTo(3f)
            horizontalLineTo(19f)
            curveTo(19.55f, 3f, 20f, 3.45f, 20f, 4f)
            verticalLineTo(10f)
            horizontalLineTo(17f)
            curveTo(16.45f, 10f, 16f, 10.45f, 16f, 11f)
            curveTo(16f, 11.55f, 16.45f, 12f, 17f, 12f)
            horizontalLineTo(20f)
            verticalLineTo(17f)
            curveTo(20f, 17.55f, 19.55f, 18f, 19f, 18f)
            horizontalLineTo(14f)
            verticalLineTo(15f)
            curveTo(14f, 14.45f, 13.55f, 14f, 13f, 14f)
            curveTo(12.45f, 14f, 12f, 14.45f, 12f, 15f)
            verticalLineTo(18f)
            horizontalLineTo(10f)
            verticalLineTo(21f)
            curveTo(10f, 21.55f, 9.55f, 22f, 9f, 22f)
            horizontalLineTo(4f)
            curveTo(3.45f, 22f, 3f, 21.55f, 3f, 21f)
            verticalLineTo(16f)
            ...
            horizontalLineTo(8f)
            verticalLineTo(16f)
            curveTo(8f, 15.45f, 8.45f, 15f, 9f, 15f)
            curveTo(9.55f, 15f, 10f, 15.45f, 10f, 16f)
            verticalLineTo(19f)
    ...
    val QQ = ImageVector.Builder(
        ...
        path(
            ...
            // 企鹅身体外轮廓
            moveTo(12f, 2f)
            curveTo(7f, 2f, 4f, 6f, 4f, 10f)
            curveTo(4f, 12f, 4.5f, 13.5f, 5.5f, 14.5f)
            curveTo(5.3f, 15f, 4.8f, 16.5f, 4.3f, 17.5f)
            curveTo(3.8f, 18.5f, 4.5f, 19.5f, 5.5f, 19.5f)
            curveTo(7f, 19.5f, 8.5f, 18.8f, 9.5f, 18f)
            curveTo(10.3f, 18.3f, 11.2f, 18.5f, 12f, 18.5f)
            curveTo(17f, 18.5f, 20f, 14.5f, 20f, 10.5f)
            curveTo(20f, 6.5f, 17f, 2f, 12f, 2f)
            close()
            
            // 左眼
            moveTo(9f, 9f)
            curveTo(9f, 8.2f, 9.6f, 7.5f, 10.4f, 7.5f)
            curveTo(11.2f, 7.5f, 11.8f, 8.2f, 11.8f, 9f)
            curveTo(11.8f, 9.8f, 11.2f, 10.5f, 10.4f, 10.5f)
            curveTo(9.6f, 10.5f, 9f, 9.8f, 9f, 9f)
            close()
            
            // 右眼
            moveTo(13.5f, 9f)
            curveTo(13.5f, 8.2f, 14.1f, 7.5f, 14.9f, 7.5f)
            curveTo(15.7f, 7.5f, 16.3f, 8.2f, 16.3f, 9f)
            curveTo(16.3f, 9.8f, 15.7f, 10.5f, 14.9f, 10.5f)
            curveTo(14.1f, 10.5f, 13.5f, 9.8f, 13.5f, 9f)
            close()
            
            // 嘴巴
            moveTo(10.5f, 12.5f)
            curveTo(10.5f, 12f, 10.8f, 11.5f, 11.3f, 11.5f)
            horizontalLineTo(13.2f)
            curveTo(13.7f, 11.5f, 14f, 12f, 14f, 12.5f)
            curveTo(14f, 13.3f, 13.2f, 14f, 12f, 14f)
            curveTo(10.8f, 14f, 10f, 13.3f, 10.5f, 12.5f)
            close()
        }
    }.build()
}
